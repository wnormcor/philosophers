...
/*   Updated: 2021/02/22 12:43:27 by wnormcor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct		s_ctrl
{
	...
	pthread_t		die_pth_id;
	pthread_t		eat_pth_id;
}					t_ctrl;
...
typedef struct		s_philo
{
	...
	sem_t			*resolve_mt;
	char			*startchk_mt_name;
	sem_t			*startchk_mt;
	char			*startphl_mt_name;
	sem_t			*startphl_mt;
	long long		die_time;
	int				num_eats;
	t_ctrl			*ctrl;
	pthread_t		check_pth_id;
}					t_philo;
...
int					ph_philo_proc(t_philo *philo);
